...
public class testcase13 {
	...
	@When("^ click on view product for any product on homepage $")
	public void click_on_view_product_for_any_product_on_homepage() throws InterruptedException
	{
	...
	public void verify_product_detail_is_opened() throws InterruptedException
	{
		//Method to call Dashboard4
		Dashboard4 dashboard4 = new Dashboard4(driver);
		dashboard4.clickOnViewProduct1();
		dashboard4.verifyProductDetails();
	}
	...
	public void click_on_view_cart_button() throws InterruptedException
	{
		//Method to call Dashboard4
		Dashboard4 dashboard4 = new Dashboard4(driver);
		dashboard4.clickOnViewCartLink();
	}
	@Then("^ verify product is displayed in cart page with exact quantity $")
	public void verify_product_is_displayed_in_cart_page_with_exact_quantity()
	{
		//Method to call Dashboard4
		Dashboard4 dashboard4 = new Dashboard4(driver);
		dashboard4.verifyCheckout();
		dashboard4.verifyQuantityCheckout();
	}
	@After(order=1)
	public void logout()
	{
